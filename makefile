...
#
#TOOL INPUT
SRC = USB_Host_model.v driver_authentication.v Responder.v get_digests.v challenge.v Error_response.v get_certificate.v Timeout.v Initiator.v get_certificate_control.v Get_Cert_generator.v Certificate_compare.v
